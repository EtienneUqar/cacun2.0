...
st.markdown(f'<p class="font3"> -Les coûts reliés à occupation des places dans avion par les passagers sont de : {round(vol_Cancun.couts_passager(), 2)} $. </p>', unsafe_allow_html=True)
